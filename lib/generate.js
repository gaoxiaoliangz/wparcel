 ...
 * @param {{ disableDepCheck, verbose, polyfill, node, excludeExternals, css, sass, babel: { react, babelrc }, typescript, graphql, media: { loadImgWithUrlLoader }, production: { compress } }} userConfig 
...
const generageConfig = (userConfig, webpackConfig2) => {
  ...
  if (features.length !== 0) {
    ...
    const rulesNoFile = _.flow(
      ...
      _.flatten,
      _.curryRight(_.map)(r => _.omit(r, ['__type']))
    )(ruleConfigs)
