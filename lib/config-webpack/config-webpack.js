 ...
 * @param {{ define: Object, disableDepCheck, verbose, polyfill, node, excludeExternals, css, sass, babel: { react, babelrc }, typescript, graphql, media: { dataUrl }, production: { compress } }} userConfig 
