...
const rules = {
  ...
  sass({ isomorphic, extract, sourceMap, scoped, globalFileExt = 'global' }) {
    if (scoped) {
      ...
      return [
        makeStyleRule({ isomorphic, extract, sourceMap, scoped: true, test: testLocal }),
        makeStyleRule({ isomorphic, extract, sourceMap, scoped: false, test: testGlobal }),
      ]
    }
    return makeStyleRule({ isomorphic, extract, sourceMap, scoped: false, test: /\.scss$/ })
  },
